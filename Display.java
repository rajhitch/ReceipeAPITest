...
public class Display {
    ...
    public Display(String s){
        ...
        bt2=new ButtonsTwo();bt3=new ButtonsThree();
        setTabs();runWindow();}
...
class MyButton extends JPanel{
    JButton b;public MyButton(String s1){b=new JButton(s1);this.add(b);
    b.setSize(50,20);}
    public void addFunction(ActionListener al){b.addActionListener(al);}}

class ButtonsTwo extends JPanel{
    private JButton b1,b2,b3;
    public ButtonsTwo(){b1=new JButton("Generate Recipes");
        b2=new JButton("Generate Menu");b3=new JButton("Clear Selections");
        this.add(b1);this.add(b2);this.add(b3);}
    public void addFuncOne(ActionListener al){b1.addActionListener(al);}
    public void addFuncTwo(ActionListener al){b2.addActionListener(al);}
    public void addFuncThree(ActionListener al){b3.addActionListener(al);}
}

class ButtonsThree extends JPanel{
    private JButton b1,b2,b3;
    public ButtonsThree(){b1=new JButton("Rename Menu");
        b2=new JButton("Save Menu");b3=new JButton("Print Menu");
        this.add(b1);this.add(b2);this.add(b3);}
    public void addFuncOne(ActionListener al){b1.addActionListener(al);}
    public void addFuncTwo(ActionListener al){b2.addActionListener(al);}
    public void addFuncThree(ActionListener al){b3.addActionListener(al);}
